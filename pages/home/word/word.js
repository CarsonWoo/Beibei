...
Page({
  ...
  onGraphFail: function() {
    ...
    switch (wrongCount) {
      ...
      default:
        wx.navigateTo({
          url: 'word_detail/word_detail?wrongCount=' + wrongCount + "&word_id=" + this.data.word_list[this.data.realPointer].id,
        })
        break
    }
  },
  ...
  onSentenceTap: function(event) {  
    ...
    if (audioCtx) {
      audioCtx.stop()
      audioCtx.src = this.data.word_list[this.data.realPointer].sentence_audio
      audioCtx.play()
    }
  },
  ...
  onWordTap: function(event) {
    ...
    if (audioCtx) {
      audioCtx.stop()
      audioCtx.src = this.data.word_list[this.data.realPointer].pronunciation_us
      audioCtx.play()
    }
  },
